...
@Autonomous
public class blueLeftFail extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d startPose = new Pose2d(-37.25, 62, Math.toRadians(270));

        drive.setPoseEstimate(startPose);

        Trajectory sec = drive.trajectoryBuilder(new Pose2d(-37.25, 62, Math.toRadians(270)))
