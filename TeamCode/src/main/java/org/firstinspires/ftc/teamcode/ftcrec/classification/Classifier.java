package org.firstinspires.ftc.teamcode.ftcrec.classification;
...
public abstract class Classifier {
    ...
    public static Classifier create(Activity activity, Model model, Device device, int numThreads, String modelFileName, String labelFileName, Telemetry t)
        ...
        if (model == Model.QUANTIZED_MOBILENET) {
            return new org.firstinspires.ftc.teamcode.ftcrec.classification.ClassifierQuantizedMobileNet(activity, device, numThreads, modelFileName, labelFileName, t);
        } else if (model == Model.FLOAT_MOBILENET) {
            return new org.firstinspires.ftc.teamcode.ftcrec.classification.ClassifierFloatMobileNet(activity, device, numThreads, modelFileName, labelFileName, t);
        } else if (model == Model.FLOAT_EFFICIENTNET) {
            return new org.firstinspires.ftc.teamcode.ftcrec.classification.ClassifierFloatEfficientNet(activity, device, numThreads, modelFileName, labelFileName, t);
        } else if (model == Model.QUANTIZED_EFFICIENTNET) {
            return new org.firstinspires.ftc.teamcode.ftcrec.classification.ClassifierQuantizedEfficientNet(activity, device, numThreads, modelFileName, labelFileName, t);
        } else {
