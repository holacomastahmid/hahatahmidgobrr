    ...
    @Override public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            if (!purple_finished) {
                ...
                Trajectory myTrajectory = drive.trajectoryBuilder(new Pose2d(13, -62, Math.toRadians(90)))
                        .addDisplacementMarker(() -> {
                            clawServo.setPosition(0.27);
                            handleServo.setPosition(0.26);
                        })
                        //.forward(30)
                        .splineToConstantHeading(new Vector2d(13 + offset, -32), Math.toRadians(90))
                        .splineToSplineHeading(new Pose2d(15, -44, Math.toRadians(0)), Math.toRadians(0))
